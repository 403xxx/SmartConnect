...
<a href={`/downloads/${new URL(currentJob.url).hostname}/${file.filename}`} download>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                      ...
                      <Button asChild variant="ghost" size="sm" data-testid="button-download-combined">
  <a href={`/downloads/${new URL(currentJob.url).hostname}/all_js_combined.txt`} download>
                    ...
                    <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                      ...
                      <Button asChild variant="ghost" size="sm" data-testid="button-download-manifest">
  <a href={`/downloads/${new URL(currentJob.url).hostname}/manifest.txt`} download>
                        <Download className="w-4 h-4" />
                      </Button>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                      ...
                      <Button asChild variant="ghost" size="sm" data-testid="button-download-html">
  <a href={`/downloads/${new URL(currentJob.url).hostname}/page.html`} download>
                        <Download className="w-4 h-4" />
                      </Button>
                    </div>
                  </div>
                      ...
                      <tr key={file.id} className="hover:bg-muted/50 transition-colors" data-testid={`row-file-${index}`}>
                        ...
                        <td className="py-3 px-2">
                          <div className="flex gap-2">
                            {file.status === 'success' && (
                              <>
                                <Button asChild variant="ghost" size="sm" title="Download" data-testid={`button-download-file-${index}`}>
                                  <Download className="w-4 h-4" />
                                </Button>
